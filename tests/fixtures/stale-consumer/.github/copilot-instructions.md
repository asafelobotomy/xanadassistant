...
- Keep optional capabilities out of the always-on path unless a task explicitly needs them.

<!-- user-added -->
# Custom project rule

This section is user-owned and must be preserved through updates.
<!-- /user-added -->
