"""Convergence tests for the stale-consumer fixture.

Verifies that update/repair from a committed stale-consumer fixture converges
to the same final state as a fresh install from a local package root.
